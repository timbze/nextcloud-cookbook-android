...
class DbRecipe2RecipeConverter(private val recipe: DbRecipe) {
   fun convert(): Recipe {
      return Recipe(
         context = recipe.recipeCore.context,
         id = recipe.recipeCore.id,
         idUrl = recipe.recipeCore.idUrl,
         jsonId = recipe.recipeCore.jsonId,
         ...
         imageUrl = recipe.recipeCore.imageUrl,
         thumbImageUrl = recipe.recipeCore.thumbImageUrl,
         fullImageUrl = recipe.recipeCore.fullImageUrl,
         printImage = recipe.recipeCore.printImage,
         keywords = recipe.recipeCore.keywords,
